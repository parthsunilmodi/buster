...
const OneWayTripSVG = (props: ISVGType) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 44 22" fill="none">
      ...
      <circle cx="39.6982" cy="5.56778" r="3.01907" fill="white" stroke={color} stroke-width="2" />
      <line x1="4.55835" y1="7.88184" x2="4.55835" y2="21.157" stroke={color} stroke-width="2" />
      <circle cx="4.77628" cy="5.56778" r="3.01907" fill="white" stroke={color} stroke-width="2" />
    </svg>
  );
};
