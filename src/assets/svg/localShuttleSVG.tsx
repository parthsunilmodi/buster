  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 51 26" fill="none">
      ...
      <path
        ...
        strokeWidth="2"
      />
      <line x1="46.0355" y1="7.88171" x2="46.0355" y2="21.1569" stroke={color} strokeWidth="2" />
      <circle cx="46.2534" cy="5.56766" r="3.01907" fill={circleFill} stroke={color} strokeWidth="2" />
      <line x1="4.55823" y1="7.88184" x2="4.55823" y2="21.157" stroke={color} strokeWidth="2" />
      <circle cx="4.77615" cy="5.56778" r="3.01907" fill={circleFill} stroke={color} strokeWidth="2" />
    </svg>
  );
};
